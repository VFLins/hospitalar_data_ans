...
value_boxes <- list(
    ...
    value_box(
        title = "2ª Etapa",
        value = HTML("<a href='https://vflins.github.io/hospitalar_data_ans/eda.html'>EDA e Modelagem</a>"),
...
value_boxes <- list(
    value_box(
        title = "1ª Etapa",
        value = HTML("<a href='https://github.com/VFLins/hospitalar_data_ans/blob/remake/notebooks/collect_routine_ans.ipynb'>Coleta de dados</a>"),
        showcase = bs_icon("database-fill-down"),
        fill = FALSE,
