...
Como estamos usando um modelo em que as previsões são desbalanceadas, e em que o falso negativo (erro tipo 1) é mais indesejado que os falsos negativos (erro tipo 2), nossas métricas de erro deve priorizar a capacidade do modelo de prever corretamente os casos positivos e minimizar os erros tipo 1. Por este motivo, ambas as métricas que escolhemos incorporam a *Taxa de Positivo Verdadeiro* (ou *recall*) e o *Valor Preditivo Verdadeiro* (ou *Precision*).
