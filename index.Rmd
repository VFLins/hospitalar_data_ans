...
p <- ggplot(mauc, aes(x=threshold, y=metric, color=mdl, fill=mdl)) + 
	geom_line() + geom_hline(yintercept=0, color=cores[3], linetype="dotted") +	
	my_ggtheme() + theme(legend.position="none") + scale_color_manual(values=clr)
ggplotly(p)
```
