...
mdl1_v2 <- glm(ACIONAMENTO_DO_SEGURO ~ modalidade + idade * regiao, data=mdl1_df)
mdl1_v3 <- glm(ACIONAMENTO_DO_SEGURO ~ idade * trimestre, data=mdl1_df)
mdl1_v4 <- glm(ACIONAMENTO_DO_SEGURO ~ idade * trimestre * regiao, data=mdl1_df)
```
